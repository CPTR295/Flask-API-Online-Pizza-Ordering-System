...
class CategoryRepository:
    ...
    def delete(self, id:int) -> bool:
        try:
           c = self.sess.query(Category).filter(Category.id == id).delete()
           self.sess.commit()
...
class PizzaRepository():
    ...
    def delete(self, code:str) -> bool:
        try:
           p = self.sess.query(Pizza).filter(Pizza.code == code).delete()
           self.sess.commit()
...
class NonPizzaRepository():
    ...
    def delete(self, code:str) -> bool:
        try:
           np = self.sess.query(NonPizza).filter(NonPizza.code == code).delete()
           self.sess.commit()
...
class AddOnsRepository():
    ...
    def delete(self, code:str) -> bool:
        try:
           addons = self.sess.query(AddOns).filter(AddOns.code == code).delete()
           self.sess.commit()
